...
func (g *GraphDTO) ShortestPathWithHeuristic(startKey, endKey uint64, heuristic func(key, endKey uint64) int) (path []string, err error) {
	//g.mu.RLock()
	//defer g.mu.RUnlock()
